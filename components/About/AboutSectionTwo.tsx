          ...
          <div className="w-full px-4 lg:w-1/2">
            <div className="wow fadeInUp max-w-[470px]" data-wow-delay=".2s">
              ...
              <div className="mb-1">
                ...
                <p className="text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed">
                  We go beyond implementation with robust support and training.
                  Our dedicated team offers 24/7 assistance to quickly resolve
                  issues. We also provide customized training sessions,
                  empowering clients to fully utilize our advanced technologies
                  and maximize their long-term benefits.
                </p>
              </div>
            </div>
          </div>
